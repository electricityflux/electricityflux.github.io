...
0.3 MtCO<sub>2</sub>e was emitted in the UK during 2023 due to SF<sub>6</sub> emissions, equating to 13 t of SF<sub>6</sub>. Of these emissions, National Grid Electricity Transmission was responsible for 9276 kg, Scottish Power was responsible for 689 kg and Scottish and Southern Electricity was responsible for 406 kg. Overall emissions were 385 MtCO<sub>2</sub>e, making the contribution from SF<sub>6</sub> 0.01%.

# The future of insulating mediums
It is highly likely that a gas-insulation medium will be essential at certain substations due to space constraints. This means that solutions to the SF<sub>6</sub> problem are limited to using less harmful alternative gases. Alternative gases are being introduced for new installations, which are significantly less harmful to the environment by companies such as GE Grid Solutions ([g<sup>3</sup>](https://www.gevernova.com/grid-solutions/equipment/gas-insulated-switchgear) gas, which has a GWP of 235) and Hitachi ([EconiQ](https://www.hitachienergy.com/sustainability/econiq) gas, which has a GWP of 400). For existing substations, recycling SF<sub>6</sub>, rather than using virgin gas, is one way of minimising emissions. Naturally, fixing existing leaks and utilising capture devices will also minimise emissions. One of the most promising solutions for existing installations is retro-filling, whereby existing equipment has its SF<sub>6</sub> gas removed, and a lower GWP replacement is used to take its place. This is estimated to be an order of magnitude less expensive than replacement with entirely new equipment utilising the low GWP gas. 
