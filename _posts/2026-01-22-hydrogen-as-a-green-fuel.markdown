...
<p align="center">
Figure 1. Effect of hydrogen fraction in a hydrogen and natural gas blend.
</p>

## Hydrogen safety

Hydrogen is a very small element, meaning that it is more prone to leaks when compared with other hydrocarbon-based gases. Expensive leak-sensing equipment and modifications, due in part to leaks but also hydrogen embrittlement, to existing gas equipment are required where a replacement is to take place. The explosion risk for hydrogen is much more significant than natural gas, too, due to the prevalence of leaks and the higher flammability range from 4-75% compared to methane at around 5-15% by volume in air.
