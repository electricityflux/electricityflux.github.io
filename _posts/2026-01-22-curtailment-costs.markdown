...
# The cost and need for curtailment
...
An alternative mitigation of curtailments could be to utilise energy storage devices, such as batteries, local to the generation connection. These devices charge up during times when generators would normally be curtailed, and then, during generation troughs, they could export to the grid. This would ensure that transmission equipment was not overloaded and would prevent energy from being wasted, but would still require electricity to be purchased from alternative sources when the energy storage devices were being used. Currently, coordination between energy storage systems and generation does not capitalise on these possibilities, mainly because there is no incentive to do so.
